...
import {
  ...
  useAnimationFrame,
  useMotionValue,
} from "motion/react"; // Asegúrate de haber corrido 'npm install motion'
import { wrap } from "@motionone/utils"; // Asegúrate de haber corrido 'npm install @motionone/utils'
...
// Tu componente de animación, renombrado para mayor claridad
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-secondary py-4 border-b border-border">
        <ScrollingTextBanner
          baseVelocity={-1} // Ajusta la velocidad como prefieras
          clasname="font-light tracking-tight text-luxury-gold"
        >
